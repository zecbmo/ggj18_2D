...
public enum RefractionCameraType { background, localObjects };
...
public class ScreenSpaceRefractions : MonoBehaviour
{
    ...
    [SerializeField]
    RefractionCameraType type = RefractionCameraType.background;
    ...
    private string _globalTextureNameForBackground = "_GlobalRefractionTexGlobal";
    private string _globalTextureNameForLocalObjects = "_GlobalRefractionTexLocal";
    ...
    void GenerateRT()
    {
        ...
        string _globalTextureName = _globalTextureNameForBackground;
        if (type == RefractionCameraType.background) {
            _globalTextureName=_globalTextureNameForBackground;
        }
        else if(type ==RefractionCameraType.localObjects){
            _globalTextureName = _globalTextureNameForLocalObjects;
